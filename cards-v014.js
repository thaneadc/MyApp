export const DATA = {
  ...
  "cards": [
    ...
    },
    {
      ...
      "type": "Search / Utility",
      "text": "- Gain +1 Search\n- Before selecting a Mission, look at the face-down card\n  beneath one Mission stack"
    },
    {
      "id": "T02",
      ...
      "type": "Search",
      "text": "- Gain +1 Search\n- In Final Isle, gain +1 additional Search"
    },
    {
      "id": "T03",
      "name": "STORMGLASS",
      ...
      "type": "Utility",
      "text": "- If you fail a Mission without Skull, regain 1 Supply"
    },
    {
      "id": "T04",
      "name": "WINDCALLER CONCH",
      "kind": "treasure",
      "art": {
        "sheet": "treasure",
        "sourceWidth": 1145,
    ...
    },
    {
      ...
      "type": "Combat / Economy",
      "text": "- On a Combat Mission, if at least one die shows 2, gain +1 Gold"
    },
    {
      "id": "T07",
      ...
      "type": "Combat",
      "text": "- Before rolling a Combat Mission, you may pay 1 extra Supply\n- If you do, gain +2 Combat"
    },
    {
      "id": "T08",
      "name": "CRIMSON CAPTAIN'S SABRE",
      "kind": "treasure",
      "art": {
        "sheet": "treasure",
        "sourceWidth": 1145,
      ...
      "type": "Combat / Economy",
      "text": "- Gain +1 Combat\n- If a Combat Mission succeeds, gain +2 Gold"
    },
    {
      "id": "T09",
      "name": "GOLDEN SPYGLASS",
      "kind": "treasure",
      "art": {
        "sheet": "treasure",
        "sourceWidth": 1145,
      ...
      "type": "Economy",
      "text": "- Each Gold die result gives +1 additional Gold"
    },
    {
      "id": "T10",
      ...
      "type": "Search / Supply",
      "text": "- Gain +1 Search\n- On Mission success, gain +1 Supply"
    },
    {
      "id": "T11",
      "name": "TEMPLE KEY",
      ...
      "type": "Utility",
      "text": "- Once per Expedition, before paying Supply,\n  switch to another available Mission in the same Zone"
    },
    {
      "id": "T12",
      ...
      "type": "Search / Economy",
      "text": "- Gain +1 Search\n- If you complete a Search Mission with target 8 or more, gain +2 Gold"
    },
    {
      "id": "T13",
      "name": "LUCKY DOUBLOON",
      ...
      "type": "Utility",
      "text": "- If no Skull is rolled, gain +2 to the final result"
    },
    {
      "id": "T14",
      "name": "LOADED BONES",
      ...
      "type": "Utility",
      "text": "- If no Skull is rolled, change one die showing 0 into 1"
    },
    {
      "id": "T15",
      "name": "FATE'S COIN",
      ...
      "type": "Economy",
      "text": "- If you fail a Mission without Skull, gain +2 Gold"
    },
    {
      "id": "T16",
      ...
      "type": "Economy",
      "text": "- If you roll Skull and at least one Gold, gain +1 additional Gold"
    },
    {
      "id": "T17",
      ...
      "type": "Economy",
      "text": "- On Mission success, gain +2 Gold"
    },
    {
      "id": "T18",
      "name": "BOTTOMLESS RUM BARREL",
      "kind": "treasure",
      "art": {
        "sheet": "treasure",
        "sourceWidth": 1145,
    ...
    },
    {
      ...
      "type": "Protection",
      "text": "- Discard this card to prevent losing 1 Crew when a Mission fails"
    },
    {
      "id": "T20",
      "name": "CURSED CROWN",
      ...
      "type": "Economy",
      "text": "- Mission success: gain +3 Gold\n- Mission failure: lose 1 Gold"
    },
    {
      "id": "Z1-01",
      "name": "TAX COLLECTOR'S SLOOP",
      "kind": "zone1",
      "art": {
        "sheet": "zone1",
        "sourceWidth": 1536,
    ...
    {
      "id": "F4",
      "name": "THRONE OF THE PIRATE KING",
      "kind": "final",
      "art": {
        "sheet": "final",
        "sourceWidth": 1536,
